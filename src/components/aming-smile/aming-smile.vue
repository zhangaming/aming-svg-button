<template>
  <div class="aming-slime" ref="amingButton" @click="click" >
    <svg
      x="0px"
      y="0px"
      width="125px"
...
export default {
  ...
  methods: {
    ...
    click() {
      ...
      let numSlime = Math.floor(Math.random() * this.colors2.length)
...
.aming-slime
  ...
  @keyframes changeForme
    ...
    100% 
      ...
      transform scaleX(1) scaleY(1)
  .yeux
    animation cligneYenx 3s infinite ease-in-out
@keyframes respire
  0%
    transform-origin 50% 100%
    transform scaleX(1) scaleY(1)
